...
- SQLite FTS5 comme backend *par défaut* — confirme le choix ICOS de commencer par Postgres FTS.
...
- L'EventBus est technique seulement; il travaille *au-dessus* de l'Event Journal métier, jamais à sa place.
