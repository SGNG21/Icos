...
describe("CkShell", () => {
  ...
  it("renders the top bar with the ICOS brand", () => {
    const html = renderToStaticMarkup(<CkShell sidebar={<div />} conversation={<div />} />);
  ...
  it("renders the footer bar when provided", () => {
    const html = renderToStaticMarkup(
      <CkShell sidebar={<div />} conversation={<div />} footerBar={<div>FOOTER_CONTENT</div>} />,
    );
  ...
  it("renders the top-bar right slot when provided", () => {
    const html = renderToStaticMarkup(
      <CkShell sidebar={<div />} conversation={<div />} topBarRight={<div>TOPBAR_RIGHT</div>} />,
    );
